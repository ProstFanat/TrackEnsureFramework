...
public class HosEditorPage {
    ...
    private SelenideElement driverSelect = $x("//ng-select[@placeholder = 'Select Driver']//input"),
    ...
    public Boolean isBtnOpenTransactionDisplayed(){
        LOG.info("Is btn take transaction displayed - " + btnOpenTransaction.isDisplayed());
        return btnOpenTransaction.isDisplayed();
    }

    @Attachment
    public Boolean isBtnProcessedVisibleDisplayed(){
        LOG.info("Is btn take transaction displayed - " + btnProcessed.is(Condition.visible));
